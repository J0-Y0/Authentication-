...
SECRET_KEY = "django-insecure-8m1(wmrfs6ibx6v2^jtn$hd2vr2-wysb4^t3hgj^w-an419xzu"
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "account_api.serializers.MyTokenObtainPairSerializer",
